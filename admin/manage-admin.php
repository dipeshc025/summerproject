...
<div class="main-content">
   <div class="wrapper">
      ...
      if (isset($_SESSION['delete'])) {
         echo $_SESSION['delete']; //Deleting Session Message
         ...
         if ($res == TRUE) {
            ...
            if ($count > 0) {
               ...
               while ($rows = mysqli_fetch_assoc($res)) {
                  //using while loop all the data from database
                  ...
                  <tr>
                     ...
                     <td>
                        <a href="<?php echo SITEURL; ?>admin/update-password.php?id=<?php echo $id; ?>" class="btn-primary">Change
                           Password</a>
                        <a href="<?php echo SITEURL; ?>admin/update-admin.php?id=<?php echo $id; ?>" class="btn-secondary">update
                           admin</a>
